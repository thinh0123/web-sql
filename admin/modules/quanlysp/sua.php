...
?>
 <form method="POST" action="modules/quanlysp/xuly.php?idsanpham=<?php echo $row['id_sanpham'] ?>" enctype="multipart/form-data">
	  ...
	  <tr>
	    ...
	    <td>
	    	<select name="danhmuc">
	    		...
	    		?>
	    		<option selected value="<?php echo $row_danhmuc['id_dm'] ?>"><?php echo $row_danhmuc['ten_dm'] ?></option>
	    		<?php
	    			}else{
	    		?>
	    		<option value="<?php echo $row_danhmuc['id_dm'] ?>"><?php echo $row_danhmuc['ten_dm'] ?></option>
	    		<?php
	    			}
	    		} 
	    		?>
	  ...
	  <tr>
	   ...
	   <tr>
	    <td colspan="2"><input type="submit" name="suasanpham" value="Sửa phòng"></td>
	  </tr>
 </form>
 <?php
 } 
